                                        ...
                                        gpointer         user_data)
{
	...
	treeview=lookup_widget(windowafficher,"treeview1");
		...
		consulter_capt(treeview,"capteurs_def.txt" );
...
on_button_aj_clicked                   (GtkWidget       *objet,
                                        gpointer         user_data)
{
GtkWidget *aj1, *aj2, *aj3, *a, *b, *c, *check, *pInfo;
GtkCalendar *ajc;
menu u;
...
on__clicked                            (GtkWidget       *objet,
                                        gpointer         user_data)
{
GtkWidget *windowcnx,*MENU_PRINCIPAL;
MENU_PRINCIPAL=lookup_widget(objet,"MENU_PRINCIPAL");

gtk_widget_destroy(MENU_PRINCIPAL);
windowcnx=create_windowcnx();
gtk_widget_show(windowcnx);
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if (c==1)
{Admin=create_windowinterf();
gtk_widget_show(Admin);
gtk_widget_hide(Login);
treeview=lookup_widget(Admin,"treeview1");
afficherstock(treeview) ;
}
/*
else if (c==2)
{Worker=create_Ouvrier();
gtk_widget_show(Worker);
gtk_widget_hide(Login);
}
*/
else 
