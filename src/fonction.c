...
char empty[50]="\0" ;
FILE *f;
f=fopen("/home/amine/Bureau/amine/src/prod.txt","a+");
if(f!=NULL)
...
f=fopen("/home/amine/Bureau/amine/src/prod.txt","r");
f1=fopen("/home/amine/Bureau/amine/src/prod1.txt","w");
if (f!=NULL){
    if(f1!=NULL){
while(fscanf(f,"%s %s %d \n",id,type,&quant)!=EOF ) {
    if(strcmp(id1,id)!=0)  
...
fclose(f);
if (r){
	remove ("/home/amine/Bureau/amine/src/prod.txt");
	rename ("/home/amine/Bureau/amine/src/prod1.txt","/home/amine/Bureau/amine/src/prod.txt");
	}
...
FILE *f1;
f=fopen("/home/amine/Bureau/amine/src/prod.txt","r");
f1=fopen("/home/amine/Bureau/amine/src/alerte.txt","w");
if(f!=NULL)
{if(f1!=NULL)
{while(fscanf(f,"%s %s %d \n",id,type,&quant)!=EOF) 
{
...
f=fopen("/home/amine/Bureau/amine/src/alerte.txt","r") ; 
if (f==NULL) 
{
return ; 
}
...
{
f=fopen("/home/amine/Bureau/amine/src/alerte.txt","a+") ;
 while(fscanf(f,"%s %s %d \n",id,type,&quant)!=EOF) 
{
gtk_list_store_append (store,&iter) ; 
